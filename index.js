...
function formatearNumeroTelefono(numero) {
  ...
  if (formattedNumber.startsWith('+57') && !formattedNumber.startsWith('+573')) {
    formattedNumber = formattedNumber.replace('+57', '+573');
  } else if (formattedNumber.startsWith('57') && !formattedNumber.startsWith('573')) {
    formattedNumber = `+573${formattedNumber.slice(2)}`;
  } else if (formattedNumber.startsWith('57') && formattedNumber.length >= 12) {
