...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '𝕏𝕒𝕧𝕪𝔹𝕠𝕥', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/Ochoa21/XavyBot-MD'}, mentionedJid: [m.sender]}}}, aa);
