...
const sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Ochoa, tu seras XavyBot.`;
...
handler.command = /^(openaivoz|chatgptvoz|iavoz|robotvoz|openai2voz|chatgpt2voz|ia2voz|robot2voz|gptvoz|ai_voz|ai_voce)$/i;
