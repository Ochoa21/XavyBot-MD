...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
        ...
        let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Ochoa, tu seras XavyBot.`;
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Ochoa, tu seras XavyBot.`;
...
handler.command = /^(openai|chatgpt|ia|robot|openai2|chatgpt2|ia2|robot2)$/i;
