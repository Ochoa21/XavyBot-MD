...
mobile: MethodMobile, 
browser: opcion == '1' ? ['XavyBot-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['XavyBot-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
auth: {
creds: state.creds,
...
if (reason == 405) {
await fs.unlinkSync("./OchoaSession/" + "creds.json")
